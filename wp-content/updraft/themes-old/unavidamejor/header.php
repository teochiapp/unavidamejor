...
<body <?php body_class(); ?>>
  ...
  <header class="site-header">
    <div class="header-container container d-flex align-items-center justify-content-between">
      ...
      <nav class="main-nav">
        <ul>
          <li><a href="<?php echo esc_url(home_url('/')); ?>" class="nav-link" data-scroll>INICIO</a></li>
      ...
      <div class="header-button">
        <button class="main-button"><a href="<?php echo esc_url(home_url('/')); ?>#contact" data-scroll>CONTACTANOS!</a></button>
      </div>
    </div>
